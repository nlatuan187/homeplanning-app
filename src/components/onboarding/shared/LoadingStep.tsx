...
export default function LoadingStep({
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden">
      {/* 
        ĐÂY LÀ PHẦN CODE ĐỂ TẠO HIỆU ỨNG NỀN DI CHUYỂN
        Nó sử dụng motion.img với animate và transition.
      */}
      <motion.img
        src="/Ellipse 30.png"
      ...
      {title && (
        <div className="absolute top-5 left-1/2 -translate-x-1/2 font-semibold text-white text-lg">
          {title}
        </div>
      )}
      ...
      <h2 className="text-xl font-semibold text-white">
        {message || "Đang bận rộn tính toán"}...
      </h2>
    </div>
  );
}
